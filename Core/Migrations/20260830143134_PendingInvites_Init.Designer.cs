...
namespace Core.Migrations
{
    ...
    [Migration("20260830143134_PendingInvites_Init")]
    partial class PendingInvites_Init
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.PendingInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Core.Entities.RealmConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.RealmConnection", b =>
                {
                    b.HasOne("Core.Entities.Realm", "Realm")
                        .WithOne("Connection")
                        .HasForeignKey("Core.Entities.RealmConnection", "RealmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
